...
void test_unit_DecimalToHexadecimal(void) {
  TEST_ASSERT_EQUAL(12, dechexa("C"));
  TEST_ASSERT_EQUAL(10, dechexa("A"));
  TEST_ASSERT_EQUAL(15, dechexa("F"));
  TEST_ASSERT_EQUAL(2, dechexa("2"));
}

void test_unit_HexadecimalToDecimal(void) {
  TEST_ASSERT_EQUAL("F", hexadec(15));
  TEST_ASSERT_EQUAL("E", hexadec(14));
  TEST_ASSERT_EQUAL("B", hexadec(11));
}
